...
const signUpSchema = yup.object({
    ...
    password_confirm:  yup.string().required('Confirme a Senha').oneOf([yup.ref('password')], 'as duas senha devem ser iguais.')
...
export function SignUp() {
    ...
    function handleGoBack (){
     ...
     async function handleSignUp({ name, email, password }: FormDataProps) {
        const response = await fetch('http://192.168.0.64.:3333/users', {
          method: 'POST',
          headers: {
